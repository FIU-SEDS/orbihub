...
from orbihub.core.database import (
    add_installed_app,
...
def install_app(
    app_id: str, name: str, version: str, repo_url: str
) -> Tuple[bool, str]:
...
def app_launch(app_id: str) -> Tuple[bool, str]:
    ...
    try:
        ...
        entry_point = app_path / "__main__.py"

        if not entry_point.exists():
            return (
                False,
                f"Entry point not found: {entry_point}. Apps must have __main__.py at root level.",
            )
